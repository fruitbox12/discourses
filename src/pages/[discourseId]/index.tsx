...
const DiscoursePage = () => {
    ...
    const handleExplorer = (tx: string) => {
        window.open(`https://rinkeby.etherscan.io/tx/${tx}`, "_blank");
    }
    ...
    return (
        <div className="w-full h-screen ">
            ...
            <Layout >
                <div className='w-32 h-32 bg-gradient hidden sm:flex rounded-full blur-3xl fixed top-24 right-[25vw] z-0' />
                ...
                <div className='w-full min-h-screen flex flex-col py-10 gap-4 z-10'>
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between mt-10 mx-10 lg:mx-0">
                        ...
                        <div className="flex flex-col gap-2 w-full md:flex-[0.6]">
                            ...
                            <div className="bg-card flex flex-col gap-2 p-6 rounded-xl w-max md:max-w-[80%] mt-2">
                            ...
                            <div className="flex items-center gap-4 mt-8">
                                <div className="flex flex-col">
                                    ...
                                    <h3 className="text-white/80 text-lg font-bold tracking-wider">Ξ {getFundTotal(data.getDiscourseById.funds)}</h3>
                                </div>
